...
FROM Prova
WHERE designacao LIKE 'C%' AND distancia BETWEEN 25 AND 100;
...
--competiçoes com mais do que 1 prova a ser realizada em 2016
SELECT nome  'nome                ', data, regiao
FROM Competicao
WHERE nome IN
	(SELECT p1.nome
	FROM Prova p1, Prova p2
	WHERE p1.data >= '2016-01-01'
	AND p2.data >= '2016-01-01'
	AND p1.nome = p2.nome
	AND p1.id != p2.id);
